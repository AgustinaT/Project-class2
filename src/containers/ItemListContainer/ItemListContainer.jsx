...
const ItemListContainer = ({ greeting}) => { //10
  ...
  const products = [
    { id: 1, nombre: "Demon Slayer", precio: "$700", descripcion: "Kimetsu no Yaiba, Guardianes de la noche en España, nos presenta a Kamado Tanjiro, un chico joven, bastante inteligente y con un corazón que no le abe en el pecho. Este vive son su familia y gana dinero vendiendo carbón. Pero todo cambia cuando su familia es atacada y asesinada.", imagen: "/demonSlayer.jpg", categoria:"pelicula" },
    { id: 2, nombre: "Jujutsu Kaisen", precio: "$750", descripcion: "Las emociones negativas creadas por los humanos se convierten en maldiciones y se esconden en la vida cotidiana. Estas maldiciones solo pueden ser exorcizadas.", imagen: "/jujutsukaisen1.jpg",categoria:"pelicula" },
